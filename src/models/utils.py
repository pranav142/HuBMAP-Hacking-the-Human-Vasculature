...
if __name__ == "__main__":
    df = create_df(
        train_dir="D:\\Machine_Learning\\hubmap-hacking-the-human-vasculature\\data\\train",
        json_path="D:\\Machine_Learning\\hubmap-hacking-the-human-vasculature\\data\\polygons.jsonl",
    )
    print(df.head)
